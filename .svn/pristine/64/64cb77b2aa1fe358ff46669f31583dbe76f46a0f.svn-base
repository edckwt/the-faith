...
Donate link: https://www.edc.org.kw
...
* Get the content (articles, videos, audios) of [The Faith](https://www.the-faith.com).
* Using Json API
* Using Cron Job.

PS: All the websites owned by EDC [(E-Da`wah Committee)](https://www.edc.org.kw), For Support click to [Islam.com.kw](https://www.islam.com.kw/).
